 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".ed-programs__slider")) new swiper_core_Swiper(".ed-programs__slider", {
            ...
            if (document.querySelector(".ex-doc__slider")) new swiper_core_Swiper(".ex-doc__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
        ...
        da.init();
        const links = document.querySelectorAll("[data-link-hov]");
        links.forEach((link => {
            link.innerHTML = `${link.textContent}<span>${link.textContent}</span>`;
        }));
        const selectors = document.querySelectorAll(".form-certificate__number");
        selectors.forEach((selector => {
            console.log(selector);
            const im = new Inputmask("+7 (99) 99 - 99 - 99");
            im.mask(selector);
        }));
        const selectors2 = document.querySelectorAll(".form-contacts__number");
        selectors2.forEach((selector2 => {
            console.log(selector2);
            const im2 = new Inputmask("+7 (99) 99 - 99 - 99");
            im2.mask(selector2);
        }));
        window["FLS"] = true;
        isWebp();
